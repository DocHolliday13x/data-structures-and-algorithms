...
let findShortest = (data) => {
  // Use map to create an array of objects with name and height properties
  ...
  // Use reduce to find the character with the shortest height
  let shortest = characters.reduce((acc, character) => {
    if (acc === null || character.height < acc.height) {
      return character;
    } else {
      return acc;
    }
